...
public final class AAttrAttributelist extends PAttributelist
{
    private PAttribute _attribute_;

    public AAttrAttributelist()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAttrAttributelist(
            cloneNode(this._attribute_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAAttrAttributelist(this);
    }
