...
public final class AObjlistContentlist extends PContentlist
{
    private PStatementlist _statementlist_;

    public AObjlistContentlist()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AObjlistContentlist(
            cloneNode(this._statementlist_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAObjlistContentlist(this);
    }
